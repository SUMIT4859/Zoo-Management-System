...
<head>
  ...
  <!-- Favicon-->
  <link rel="shortcut icon" href="../img/zoologo1.jpg">
      ...
      <div class="container-fluid">
        <a href="home" class="navbar-brand font-weight-bold p-0">
          <div class="d-flex align-items-center">
            <div>
              <img src="../img/zoologo1.jpg" width="70" style="border-radius: 40%" />
            </div>
        ...
        <div id="navbarSupportedContent" class="collapse navbar-collapse">
          <ul class="navbar-nav ml-auto d-lg-flex align-items-lg-center">
            ...
            <?php if (!isset($_SESSION['authenticated'])) { ?>
              ...
              <a type="button" href="../admin/public_html/admin_login" class="btn btn-outline-primary nav-btn btn-sm navbar-login-button text-white"> <i class="fas fa-sign-out-alt mr-2"></i>A-Login </a>
			  </li>
            <?php } else { ?>
    ...
    <div class="container py-5">
      <div class="row">
        <div class="col-lg-8 col-md-6 mb-4">
          ...
          <p class="text-muted text-small">The Zoo Management System is a digital solution designed to efficiently manage zoo operations, including animal care, staff coordination, visitor management, and ticketing. This system streamlines administrative tasks, ensuring proper record-keeping of animal species, health, feeding.</p>
          <p class="text-muted text-small">With an intuitive interface and automated features, the Zoo Management System improves efficiency, enhances animal welfare, and provides a seamless experience for visitors and staff.
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          ...
          <p class="text-muted mb-4 text-small">Mobile + 91 853 333 4854 </p>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
          <h5 class="lined lined-dark mb-3 color-header">Popular Animals</h5>
          <ul class="list-unstyled">
            <li><a href="animals?class_id=1" class="footer-link text-small">Mammals</a></li>
            <li><a href="animals?class_id=4" class="footer-link text-small">Reptiles & Amphibians</a></li>
            <li><a href="animals?class_id=2" class="footer-link text-small">Birds</a></li>
          </ul>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
